...
def parse_args():
    ...
    p.add_argument("--output", type=str, default="data/processed/predictions.csv",
...
if __name__ == "__main__":
    main()
    #python src/models/predict_model.py --model-uri runs:/1e2c6d7fbeab41f4a9787d45d1991601/model --input data/processed/features.csv --output data/processed/predictions.csv
